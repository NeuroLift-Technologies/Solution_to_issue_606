# AGENTS.md — NeuroLift Technologies Solution_to_issue_606 Repository Agent Gateway

> **Internal use only.** This is the repository-specific governance gateway for coding agents operating in this repository. This copy is scoped to NeuroLift-Technologies/Solution_to_issue_606, with project-specific operational context kept in this repository.
...
> **Repo-local note:** Governance docs in this repository are the working copy for NeuroLift-Technologies/Solution_to_issue_606. Keep references local unless Joshua explicitly asks for an upstream sync.
...
- Repo-local governance context: [NeuroLift-Technologies/Solution_to_issue_606](https://github.com/NeuroLift-Technologies/Solution_to_issue_606)
...
All files below live in this repository (`NeuroLift-Technologies/Solution_to_issue_606`):
