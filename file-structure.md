...
|---|---|---|---|
| **Public governance identity** | `NeuroLift-Technologies/Solution_to_issue_606` | All agents, public | Solidarity Framework principles, HAIEF attribution, org profile |
| **Private operational governance** | `NeuroLift-Technologies/Solution_to_issue_606` | Internal coding agents only | TOI-OTOI contracts, internal procedures, escalation templates, agent registration |
...
## `Solution_to_issue_606` File Structure (from nlt-business-agents)
...
| Source (nlt-business-agents) | Destination (Solution_to_issue_606) | Change |
|---|---|---|
...
| File | Content |
|---|---|
| `AGENTS.md` | Thin gateway — points to `Solution_to_issue_606` for internal governance, includes public Solidarity Framework principles |
...
1. **Create `NeuroLift-Technologies/Solution_to_issue_606`** (private repo, org members only)
2. **Populate from nlt-business-agents** using the mapping table above
3. **Update `nltotoi.json`** in `Solution_to_issue_606` to scope to org:
   ```json
   "repository": {
     "name": "NeuroLift-Technologies/Solution_to_issue_606",
     "purpose": "Repository-specific coding agent governance for Solution_to_issue_606",
     "mode": "production"
   }
   ```
...
1. Repo-local governance: https://github.com/NeuroLift-Technologies/Solution_to_issue_606/blob/main/NLT-DEV-OTOI.md
