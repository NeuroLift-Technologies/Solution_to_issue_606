...
- Ability to read files from `NeuroLift-Technologies/Solution_to_issue_606` (this repo)
...
Read `NLT-DEV-OTOI.md` in this repository (`NeuroLift-Technologies/Solution_to_issue_606`):
